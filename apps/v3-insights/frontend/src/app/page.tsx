    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      <div className="w-full max-w-md space-y-6 p-8">
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-600 text-white font-bold text-lg shadow-lg">
            V3
          </div>
          <h1 className="text-2xl font-bold text-gray-900">投资项目备案管理系统</h1>
          <p className="mt-2 text-sm text-gray-500">V3 洞察版 -- 选择角色登录</p>
        </div>
        ...
        <div className="space-y-3">
          {users.map((user) => (
            <button
              ...
              className="flex w-full items-center gap-4 rounded-xl border border-gray-200 bg-white p-4 text-left transition hover:border-emerald-400 hover:bg-emerald-50 hover:shadow-md"
            >
